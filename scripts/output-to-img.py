...
matplotlib.image.imsave("{}_se_l.png".format(basename), se_mat_l, cmap=matplotlib.cm.gray)
matplotlib.image.imsave("{}_se_r.png".format(basename), se_mat_r, cmap=matplotlib.cm.gray)
matplotlib.image.imsave("{}_bse_l.png".format(basename), bse_mat_l, cmap=matplotlib.cm.gray)
matplotlib.image.imsave("{}_bse_r.png".format(basename), bse_mat_r, cmap=matplotlib.cm.gray)